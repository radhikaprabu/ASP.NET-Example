<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Example14_CS.Login" %>
...
<body>
    ...
    <div>
        <h1>Please log in</h1>
        <span style="z-index: 1; left: 50px; top: 200px; position: absolute">Username:&nbsp;</span>
        <asp:TextBox ID="txtUser" runat="server" TabIndex="1"
            style="z-index: 1; left: 150px; top: 200px; position: absolute" />
        
        <span style="z-index: 1; left: 50px; top: 250px; position: absolute">Password:&nbsp;</span>
